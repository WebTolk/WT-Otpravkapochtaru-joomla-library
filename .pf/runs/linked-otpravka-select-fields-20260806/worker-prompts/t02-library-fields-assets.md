...
- task_id: `t02-library-fields-assets`
- run_id: `linked-otpravka-select-fields-20260806`
- assignment: `.pf/assignments/t02-library-fields-assets.yaml`
- capsule: `.pf/contexts/assignment-capsules/t02-library-fields-assets.capsule.yaml`
- workspace_access_file: `.pf/runtime/agent-runs/linked-otpravka-select-fields-20260806/t02-library-fields-assets/workspace-access.json`
...
- `changed_files` -> `.pf/artifacts/worker-fields-assets-report-20260806.md`
- `unit_tests` -> `.pf/artifacts/worker-fields-assets-report-20260806.md`
