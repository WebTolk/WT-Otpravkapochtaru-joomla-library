(() => {
    ...
    function resolveFieldByName(name) {
        ...
        const withParamsId = document.getElementById(`jform_params_${cssEscape(name)}`);
        if (withParamsId !== null) {
            return withParamsId;
        }
        ...
        const paramsExact = document.querySelector(`[name="jform[params][${cssEscape(name)}]"]`);
        if (paramsExact !== null) {
            return paramsExact;
        }
